...
echo "Installing packages as determined by Dane..."
	apt install -y vim htop python-pip git google-chrome-stable steam #!/bin/bash
...
echo
echo "Installing packages as determined by Dane..."
	apt install -y vim htop python-pip git google-chrome-stable steam caffeine #!/bin/bash
